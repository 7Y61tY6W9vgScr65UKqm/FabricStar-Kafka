...
class ReplicaFetcherThread(name: String,
  ...
  def processPartitionData(topicPartition: TopicPartition, fetchOffset: Long, partitionData: PartitionData) {
    ...
    debug("########### data ###########")
    debug("topicPartition: " + topicPartition.toString)
    debug("fetchOffset: " + fetchOffset)
    debug("partitionData: " + partitionData.toString)
    debug("partition: " + partition.toString)
    debug("records: " + records.toString)
